...
{
    /// <summary>
    ///     Returns all elements in a sequence that follow the first occurrence of an element that satisfies a specified
    ///     condition.
    /// </summary>
    ...
    /// <summary>
    ///     Returns all elements in a sequence that precede the first occurrence of an element that satisfies a specified
    ///     condition.
    /// </summary>
    /// <typeparam name="T" ></typeparam>
    /// <param name="collection" >The collection.</param>
    ...
    /// <summary>
    ///     Returns different elements from a sequence using a specified <see cref="Func {TResult}" /> selector for comparing
    ///     values.
    /// </summary>
    /// <typeparam name="T" ></typeparam>
    ...
    public static IEnumerable<T> GetRandomElements<T>(this IEnumerable<T>? collection, int count)
    {
        ...
        return collection.OrderBy(_ => Guid.NewGuid()).Take(count);
    }
    ...
    public static IEnumerable<IEnumerable<T>> ToGroups<T>(this IEnumerable<T> collection, string property)
    {
        ...
        if (!collection.HasItems()) return list;
